...
export class BreachProtocol {
  constructor(matrixSize = 5, byteRange) {
    this.params = selectRandomFrom(config.bufferKey[selectRandomFrom(Object.keys(config.bufferKey))]);
    this.byteRange = byteRange;
    this.maxBufferSize = this.params.bufferSize;
